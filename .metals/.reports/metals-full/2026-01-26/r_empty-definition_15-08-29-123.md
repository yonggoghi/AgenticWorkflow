error id: file://<WORKSPACE>/predict_send_time/data_transformation.scala:columns.
file://<WORKSPACE>/predict_send_time/data_transformation.scala
empty definition using pc, found symbol in pc: columns.
...
val tokenCols = rawDF.col@@umns.filter(x => x.endsWith("_token")).distinct
