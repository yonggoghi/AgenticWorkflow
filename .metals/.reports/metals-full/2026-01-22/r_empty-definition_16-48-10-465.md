error id: file://<WORKSPACE>/predict_send_time/raw_data_generation.scala:
...
val selectedRecords = resDFSelected.count()
println(s"Selected response data: $selectedRecords records")
println("=" * 80)
...
val userYmCount = userYmDF.count()
println(s"Unique user-ym pairs for suffix '$smnSuffix': $userYmCount")
...
val xdrRecordCount = xdrDF.count()
println(s"XDR hourly data loaded: $xdrRecordCount records")
...
val xdrMonRecordCount = xdrDFMon.count()
println(s"XDR monthly pivot data created: $xdrMonRecordCount records")
println("=" * 80)
...
val clickCountRecordCount = clickCountDF.count()
println(s"Click count features created: $clickCountRecordCount records")
println("=" * 80)
...
val mmktFilteredCount = mmktDFFiltered.count()
println(s"MMKT data filtered: $mmktFilteredCount records")
...
val responseFilteredCount = resDFSelectedFiltered.count()
println(s"Response data filtered: $responseFilteredCount records")
...
val joinedRecordCount = rawDF.count()
println(s"Feature integration completed: $joinedRecordCount records")
println("=" * 80)
...
val finalRecordCount = rawDFRev.count()
println(s"Data type conversion completed: $finalRecordCount records")
println("=" * 80)
...
println(s"Records saved: $finalRecordCount")
println("=" * 80)
...
xdrDF.unpersist()
xdrDFMon.unpersist()
xdrAggregatedFeatures.unpersis@@t()
