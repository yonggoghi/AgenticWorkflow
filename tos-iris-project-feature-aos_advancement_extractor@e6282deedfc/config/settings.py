...
class ProcessingConfig:
    ...
    num_candidate_programs: int = 15  # Number of candidate programs to consider for classification
    num_select_programs: int = 1  # Number of programs the LLM should select from candidates
