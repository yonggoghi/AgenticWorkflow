...
class MongoDBManager:
    ...
    def save_extraction_result(self, message: str, extraction_result: Dict[str, Any], 
                              extraction_prompts: Dict[str, Any], worker_id: str = "SKT1110566", 
        ...
        Args:
            ...
            worker_id: 분석 작업 요청자 ID (기본값: SKT1110566)
        ...
        try:
            ...
            document = {
                ...
                'worker_id': worker_id,              # 분석 작업 요청자 ID
...
def save_to_mongodb(message: str, extraction_result: Dict[str, Any], 
    ...
    result = manager.save_extraction_result(message, extraction_result, extraction_prompts, worker_id, message_id)
    manager.disconnect()
    return result
